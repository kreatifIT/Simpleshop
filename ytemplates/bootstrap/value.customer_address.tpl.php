...
<div class="<?= $class_group ?>">
    ...
    <select class="form-control address-select" name="<?= $this->getFieldName() ?>" data-allow-clear="true" data-placeholder="Adresse auswählen" data-ajax--url="<?= $apiUrl ?>" data-minimum-input-length="1">
        <option></option>
        <?php if ($address): ?>
            <option value="<?= $address->getId() ?>" selected="selected">
                <?= $address->getName() ?>
