...
<fieldset>
    ...
    <dl class="rex-form-group form-group">
        <dt><?= \rex_i18n::msg('dfi_shipping.notification_recipients'); ?>:</dt>
        <dd>
            <input type="text" class="form-control expanded" name="notification_recipients" value="<?= from_array($Settings, 'notification_recipients') ?>"/>
            <p class="text-muted"><?= \rex_i18n::msg('dfi_shipping.notification_recipients_notice'); ?></p>
        </dd>
    </dl>
</fieldset>
