...
<table id="invoice-summary" width="100%">
    ...
    <?php if ($Order->getValue('status') != 'CN'): ?>
        ...
        <?php $exciseFees = $shipping instanceof DfiShipping ? $shipping->getExciseFees() : 0.0; ?>
        ...
        <?php if ($shipping): ?>
            <tr>
                ...
                <td align="right">
                    &euro;&nbsp;<?= format_price($Order->getShippingCosts() - $exciseFees) ?>
                </td>
            </tr>
        <?php endif; ?>
