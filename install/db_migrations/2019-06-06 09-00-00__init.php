...
try {
    ...
    $sql->setQuery(<<<'SQL'
        ...
        VALUES
            ...
            ('rex_shop_customer', 2, 'value', 'hidden_input', 'text', 1, 0, 'ctype', '###label.ctype###', '', '', '###label.private_person###=person,###label.company###=company', 'person', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
            ...
            ('rex_shop_discount_group', 11, 'value', 'choice', 'text', 0, 0, 'ctype', '###label.ctype###', '', '', '###label.all###=all,###label.private_person###=person,###label.company###=company', 'all', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '{\"###label.all###\":\"all\",\"###label.private_person###\":\"person\",\"###label.company###\":\"company\"}', 0, '', ''),
            ...
            ('rex_shop_order', 3, 'value', 'cst_shop_inputs', 'text', 0, 0, 'invoice_num', '###simpleshop.invoice_num###', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '{\"readonly\":\"readonly\"}', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
            ...
            ('rex_shop_order', 11, 'value', 'number', '', 1, 0, 'shipping_costs', '###simpleshop.shipping_costs###', '', 2, '', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '{\"readonly\":\"readonly\"}', '', '', '', '', '', '', '', '', '', '', '', '', 10, '', '', '€', ''),
            ...
            ('rex_shop_order', 14, 'value', 'number', '', 0, 0, 'total', '###simpleshop.total_sum###', '', 2, '', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '{\"readonly\":\"readonly\"}', '', '', '', '', '', '', '', '', '', '', '', '', 10, '', '', '€', ''),
            ('rex_shop_order', 15, 'value', 'integer', 'int', 1, 0, 'quantity', '###simpleshop.amount###', '', '', '', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '{\"readonly\":\"readonly\"}', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
            ('rex_shop_order', 16, 'value', 'model_data', 'text', 1, 1, 'promotions', '###simpleshop.promotions###', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
