...
\Kreatif\Yform::ensureValueField(
    $table,
    'coupon_functions',
    'coupon_functions',
    [
...
\Kreatif\Yform::ensureValueField(
    ...
    [
        ...
        'choices'  => json_encode(
            [
                'translate:coupon.global_use_single' => 3,
                'translate:coupon.use_global'        => 1,
                'translate:coupon.use_fixedprice'    => 0,
                'translate:coupon.use_single'        => 2,
            ]
        ),
    ]
);
...
\Kreatif\Yform::ensureValueField(
    ...
    [
        ...
        'multiple'   => 0,
        'default'    => 'cart',
        'attributes' => '{"data-yform-edit-toggle-switch":"application"}',
        'choices'    => json_encode(
            [
                'Warenkorb' => 'cart',
                'Produkte'  => 'products',
...
\Kreatif\Yform::ensureValueField(
    ...
    [
        ...
        'no_db'      => 0,
        'multiple'   => 1,
        'attributes' => '{"data-yform-edit-toggle":"application:products"}',
    ]
);
